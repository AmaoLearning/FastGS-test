...
#CUDA_VISIBLE_DEVICES=0 OAR_JOB_ID=train python train.py -s /root/datasets/tandt_db/tandt/train -m output/train_dist_3dgs --eval --densification_interval 500  --optimizer_type default --test_iterations 30000 --highfeature_lr 0.042 --grad_abs_thresh 0.0015 --dense 0.01 --mult 0.7 --lambda_dist 100 --use_distortion_loss
#CUDA_VISIBLE_DEVICES=0 OAR_JOB_ID=playroom python train.py -s /root/datasets/tandt_db/db/playroom -m output/playroom_dist_3dgs --eval --densification_interval 500  --optimizer_type default --test_iterations 30000 --densify_until_iter 20000 --highfeature_lr 0.0015 --dense 0.003 --mult 0.7 --lambda_dist 1000 --use_distortion_loss
