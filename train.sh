# Neur3D Dataset
python train.py -s /root/datasets/Neu3D/coffee_martini -m output/coffee_martini --eval --iterations 30000 --lazy_load
python train.py -s /root/datasets/Neu3D/cook_spinach -m output/cook_spinach --eval --iterations 30000 --lazy_load
python train.py -s /root/datasets/Neu3D/cut_roasted_beef -m output/cut_roasted_beef --eval --iterations 30000 --lazy_load
python train.py -s /root/datasets/Neu3D/flame_steak -m output/flame_steak --eval --iterations 30000 --lazy_load
